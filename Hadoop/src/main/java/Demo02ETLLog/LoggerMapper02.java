...
public class LoggerMapper02 extends Mapper<LongWritable, Text,Text, NullWritable> {
    ...
    protected void map(LongWritable key, Text value, Context context) throws IOException, InterruptedException {
        ...
        result.append(bean.getRemote_user());
        result.append(bean.getStatus());
        result.append(bean.getHttp_user_agent());
